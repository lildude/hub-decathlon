...
from tapiriik.settings import WEB_ROOT, DECATHLONCOACH_CLIENT_SECRET, DECATHLONCOACH_CLIENT_ID, DECATHLONCOACH_API_KEY, DECATHLONCOACH_API_BASE_URL, DECATHLONCOACH_RATE_LIMITS
